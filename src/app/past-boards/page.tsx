...
const { archiveStartYear = 1995, boards: pastBoards } =
  pastBoardsData as PastBoardsConfig;
...
function YearSection({
  ...
  const committee = board.members.filter(
    (m) => !EXECUTIVE_POSITIONS.includes(m.position),
  );
