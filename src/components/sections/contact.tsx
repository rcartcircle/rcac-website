...
export function Contact() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="py-20 px-4 sm:px-6 md:py-24 bg-cream relative overflow-hidden"
    >
      {/* Decorative elements */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-navy/60 max-w-xl mx-auto">
            Have questions or want to join our creative community? We&apos;d
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 md:gap-12 max-w-5xl mx-auto items-start lg:items-stretch">
          {/* Contact Form */}
          <div
            className={`h-full transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}
          >
            <div className="h-full bg-card border border-border rounded-2xl p-5 sm:p-6 md:p-8 shadow-sm">
              ...
              <form
                ...
                className="min-h-[24rem] w-full flex flex-col gap-6"
              >
                <input
                  type="hidden"
                  name="access_key"
          ...
          {/* Social Links & Info */}
          <div
            className={`h-full flex flex-col gap-6 transition-all duration-700 delay-400 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
          >
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-navy/60">@rcartcircle</div>
                  </div>
                  <svg
                    className="w-5 h-5 text-navy/30 ml-auto group-hover:text-gold group-hover:translate-x-1 transition-all"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div className="flex items-start gap-4 rounded-xl border border-border bg-cream p-5">
                  ...
                  <div>
                    ...
                    <p className="text-base leading-relaxed text-navy">
                      Royal College Art Room, Royal College, Colombo 07, Sri
                      Lanka
                    </p>
                  </div>
                </div>
